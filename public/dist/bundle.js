...
var Sayac = (function (_React$Component) {
  function Sayac(props) {
    _classCallCheck(this, Sayac);

    _get(Object.getPrototypeOf(Sayac.prototype), 'constructor', this).call(this, props);
    this.state = { sayac: 0 };
  }

  _inherits(Sayac, _React$Component);
  ...
  _createClass(Sayac, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        { style: divStyle, onClick: this.tick.bind(this) },
        'Sayaç: ',
        this.state.sayac
      );
    }
...
_react2['default'].render(_react2['default'].createElement(Sayac, null), document.body);
